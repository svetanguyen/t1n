...
export default function Links() {
    ...
    return (
        <div className="bg-gradient-top-60 lg:bg-gradient-top-50 min-h-screen">
            <div className="pb-16 lg:pb-21 px-4 lg:px-11 pt-32 lg:pt-21 lg:grid grid-rows-2 grid-cols-2">
                ...
                <div className="col-span-1 lg:pt-20 col-start-1">
